...
BRIDGE_META = (
    ROOT
    / "task6_runtime/bridge/eif4e_af3_bridge_meta.npz"
)

OUTDIR = ROOT / "task6_runtime/affinity"
OUTDIR.mkdir(parents=True, exist_ok=True)

OUTPUT_JSON = OUTDIR / "eif4e_af3_boltz_affinity.json"
...
result = {
    "complex": "utexas_eif4e_apt1_no_msa",
